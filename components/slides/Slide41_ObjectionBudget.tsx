...
import { Wallet, Sliders, Signal, Wifi, Battery, ChevronLeft, Video, Phone, MoreVertical, MessageSquare } from 'lucide-react';

const Slide41_ObjectionBudget: React.FC<SlideProps> = ({ isActive }) => {
  return (
    <div className="w-full h-screen bg-[#0a0a0a] flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      <div className="w-full md:w-5/12 p-8 md:p-12 flex flex-col justify-center border-r border-gray-800 bg-[#111] relative z-10">
        ...
        >
            ...
            <div className="inline-flex items-center gap-2 bg-yellow-900/30 text-yellow-500 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-yellow-800/50">
                <Wallet size={14} /> Orçamento
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight leading-tight">
                "ESTÁ ACIMA DO <span className="text-yellow-500">ORÇAMENTO</span>"
            </h2>
        </motion.div>
        ...
        >
            <div className="bg-gray-900 border border-gray-800 p-6 rounded-xl">
                <h4 className="font-bold text-white text-sm uppercase mb-3 flex items-center gap-2">
                    <Sliders size={16} className="text-yellow-500"/> A Estratégia
                </h4>
                <p className="text-gray-400 leading-relaxed text-sm">
                    Nunca dê desconto imediato. Isso desvaloriza seu trabalho. Em vez disso, <span className="text-white font-bold">ajuste o escopo</span>.
                </p>
            </div>

            <div className="flex items-center gap-3 text-sm text-gray-300">
                 <div className="w-1.5 h-1.5 bg-yellow-500 rounded-full"></div>
                 Foque em resolver apenas a dor principal
            </div>
            <div className="flex items-center gap-3 text-sm text-gray-300">
                 <div className="w-1.5 h-1.5 bg-yellow-500 rounded-full"></div>
                 Mantenha o valor/hora intacto
            </div>
        </motion.div>
      </div>
      ...
      <div className="w-full md:w-7/12 bg-[#0a0a0a] flex items-center justify-center p-8 relative">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(234,179,8,0.1)_0,rgba(0,0,0,0)_60%)] pointer-events-none" />
             ...
             <div className="w-[360px] h-[720px] bg-black rounded-[3.5rem] p-3 shadow-2xl ring-4 ring-gray-800 relative">
                ...
                <div className="w-full h-full bg-[#111b21] rounded-[3rem] overflow-hidden flex flex-col relative">
                    ...
                    <div className="h-12 bg-[#202c33] w-full flex justify-between items-end px-6 pb-3 z-20 text-gray-300">
                        <span className="text-[12px] font-semibold">17:10</span>
                    ...
                    <div className="flex-1 p-4 overflow-y-auto relative z-10 flex flex-col pt-6">
                        ...
                        <div className="bg-[#202c33] p-3 rounded-xl rounded-tl-none mb-4 self-start shadow-sm max-w-[85%]">
                            <p className="text-[15px] text-white">Gostei da proposta, mas o valor ficou um pouco acima do que prevíamos para agora.</p>
                            <span className="text-[10px] text-gray-400 block text-right mt-1">17:05</span>
                        </div>
                        ...
                        >
                            <p className="text-[15px] text-white leading-relaxed whitespace-pre-line">
                                Entendo! Podemos ajustar o escopo para caber no seu orçamento.
                                <br/><br/>
                                O mais importante seria resolver <span className="font-bold">[problema principal]</span>. Posso fazer uma versão inicial focada nisso e depois evoluímos conforme os resultados aparecem.
                                <br/><br/>
                                Qual seria um valor que faz sentido para começar?
                            </p>
                            <div className="flex justify-end items-center gap-1 mt-1.5">
                                <span className="text-[11px] text-gray-300/70">17:10</span>
                                <div className="flex">
...
export default Slide41_ObjectionBudget;