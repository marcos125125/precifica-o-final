...
import { ThumbsUp, MessageSquare, Sparkles, Signal, Wifi, Battery, ChevronLeft, Video, Phone, MoreVertical } from 'lucide-react';

const Slide31_Scenario4: React.FC<SlideProps> = ({ isActive }) => {
  return (
    <div className="w-full h-screen bg-white flex flex-col md:flex-row overflow-hidden font-sans">
      
      {/* Left Panel: Scenario Context */}
      <div className="w-full md:w-5/12 p-8 md:p-12 flex flex-col justify-center border-r border-gray-100 bg-[#ccff00]/5 relative z-10">
        ...
        >
            ...
            <div className="inline-flex items-center gap-2 bg-[#ccff00] text-black px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-[#ccff00]/50">
                <ThumbsUp size={14} /> Cenário 04
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-black tracking-tight leading-tight">
                RESPONDEU DE FORMA <span className="text-gray-500">VAGA OU CURTA</span>
            </h2>
        </motion.div>
        ...
        >
            <div className="flex items-start gap-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
                <div className="bg-gray-100 p-2 rounded-full text-gray-600 shrink-0">
                    <MessageSquare size={16} />
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">
                    O cliente disse "Legal!", "Obrigado" ou mandou um emoji. Ele gostou, mas não sabe qual o próximo passo.
                </p>
            </div>
            
            <div className="flex items-start gap-4 p-4 bg-[#ccff00]/20 rounded-xl border border-[#ccff00]/30">
                <div className="bg-[#ccff00] p-2 rounded-full text-black shrink-0">
                    <Sparkles size={16} />
                </div>
                <p className="text-black/80 text-sm leading-relaxed">
                    <span className="font-bold text-black">Objetivo:</span> Assumir a liderança e propor o próximo passo lógico (agora sim você pode vender).
                </p>
            </div>
        </motion.div>
      </div>
             ...
             <div className="w-[360px] h-[720px] bg-black rounded-[3.5rem] p-3 shadow-2xl ring-4 ring-gray-200 relative">
                ...
                <div className="w-full h-full bg-[#E5DDD5] rounded-[3rem] overflow-hidden flex flex-col relative">
                    ...
                    <div className="h-12 bg-[#075E54] w-full flex justify-between items-end px-6 pb-3 z-20 text-white">
                        <span className="text-[12px] font-semibold">10:05</span>
                    ...
                    <div className="flex-1 p-4 overflow-y-auto relative z-10 flex flex-col pt-6">
                        ...
                        <div className="bg-white p-3 rounded-xl rounded-tl-none mb-4 self-start shadow-sm max-w-[80%]">
                            <p className="text-[15px] text-gray-800">Legal, gostei! 👍</p>
                        ...
                        >
                            <p className="text-[15px] text-gray-800 leading-relaxed whitespace-pre-line">
                                Que bom que gostou!
                                <br/><br/>
                                Criei pensando especificamente nos 3 pontos que comentei: <span className="font-bold">[ponto 1], [ponto 2] e [ponto 3]</span>.
                                <br/><br/>
                                Quer que eu prepare uma proposta para implementar o site completo com essa estrutura? Ou prefere conversar antes sobre como seria o processo?
                            </p>
                            <div className="flex justify-end items-center gap-1 mt-1.5">
                                <span className="text-[11px] text-gray-400">10:05</span>
                                <div className="flex">
...
export default Slide31_Scenario4;