...
import { UserX, MessageSquare, HeartHandshake, Signal, Wifi, Battery, ChevronLeft, Video, Phone, MoreVertical, Flag } from 'lucide-react';

const Slide34_BreakupMessage: React.FC<SlideProps> = ({ isActive }) => {
  return (
    <div className="w-full h-screen bg-[#0a0a0a] flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      <div className="w-full md:w-5/12 p-8 md:p-12 flex flex-col justify-center border-r border-gray-800 bg-[#111] relative z-10">
        ...
        <motion.div 
            ...
            className="mb-8"
        >
            <div className="inline-flex items-center gap-2 bg-red-900/30 text-red-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-red-800/50">
                <UserX size={14} /> Fim da Linha
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight leading-tight">
                QUANDO <span className="text-red-500">DESISTIR</span> (E COMO)
            </h2>
        </motion.div>
        ...
        >
            <div className="bg-gray-900 border border-gray-800 p-6 rounded-xl">
                <h4 className="font-bold text-white text-sm uppercase mb-2 flex items-center gap-2"><Flag size={14} className="text-red-500"/> O Momento Certo</h4>
                <p className="text-gray-400 leading-relaxed text-sm">
                    Após <span className="text-white font-bold">3 tentativas sem resposta em 15 dias</span>. Insistir mais que isso vira perseguição e queima sua marca pessoal.
                </p>
            </div>
            ...
            <div className="space-y-3">
                 <div className="flex items-center gap-3 text-sm text-gray-300">
                     ...
                     Remove a pressão completamente
                 </div>
                 <div className="flex items-center gap-3 text-sm text-gray-300">
                     <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                     Mantém a porta aberta para o futuro
                 </div>
                 <div className="flex items-center gap-3 text-sm text-gray-300">
                     <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                     Termina em tom positivo
                 </div>
                 <div className="flex items-center gap-3 text-sm text-gray-300">
                     <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                     Muitos clientes respondem justamente nessa mensagem final
                 </div>
            </div>
        </motion.div>
      </div>

      {/* Right Panel: iPhone Mockup (WhatsApp Style) */}
      <div className="w-full md:w-7/12 bg-[#0a0a0a] flex items-center justify-center p-8 relative">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.05)_0,rgba(0,0,0,0)_60%)] pointer-events-none" />
                    ...
                    <div className="flex-1 p-4 overflow-y-auto relative z-10 flex flex-col pt-6">
                        ...
                        >
                            <p className="text-[15px] text-white leading-relaxed whitespace-pre-line">
                                Carolina, sei que deve estar com mil coisas acontecendo!
                                <br/><br/>
                                Vou deixar você em paz por enquanto 😅 Mas se em algum momento quiser repensar a presença digital da Renovar, é só me chamar. Fico à disposição!
                                <br/><br/>
                                Sucesso por aí! 🚀
                            </p>
...
export default Slide34_BreakupMessage;