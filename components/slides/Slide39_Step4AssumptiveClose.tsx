...
import { CheckCircle, FileCheck, Signal, Wifi, Battery, ChevronLeft, Video, Phone, MoreVertical, ShieldCheck } from 'lucide-react';

const Slide39_Step4AssumptiveClose: React.FC<SlideProps> = ({ isActive }) => {
  return (
    <div className="w-full h-screen bg-white flex flex-col md:flex-row overflow-hidden font-sans">
      
      {/* Left Panel: Context */}
      <div className="w-full md:w-5/12 p-8 md:p-12 flex flex-col justify-center border-r border-gray-100 bg-green-50/50 relative z-10">
        ...
        >
            ...
            <div className="inline-flex items-center gap-2 bg-green-600 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 shadow-md">
                <CheckCircle size={14} /> Assumptive Close
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tight leading-tight">
                O FECHAMENTO <span className="text-green-600">SUAVE</span>
            </h2>
        </motion.div>
        ...
        >
            <div className="bg-white p-6 rounded-xl border border-green-100 shadow-sm">
                <h4 className="font-bold text-gray-900 text-sm uppercase mb-3 flex items-center gap-2">
                    <ShieldCheck size={16} className="text-green-500"/> A Técnica
                </h4>
                <p className="text-gray-600 leading-relaxed text-sm">
                    Não pergunte "Quer fechar?". Assuma que a venda já aconteceu e guie para a formalização. Isso transmite confiança e liderança.
                </p>
            </div>
            ...
            <ul className="space-y-3">
                 <li className="flex items-center gap-3 text-sm text-gray-600 font-medium">
                     ...
                     Resume os benefícios (reforço de valor)
                 </li>
                 <li className="flex items-center gap-3 text-sm text-gray-600 font-medium">
                     <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                     Apresenta o preço sem medo
                 </li>
                 <li className="flex items-center gap-3 text-sm text-gray-600 font-medium">
                     <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                     Define o próximo passo (contrato)
                 </li>
            </ul>
        </motion.div>
      </div>
             ...
             <div className="w-[360px] h-[720px] bg-black rounded-[3.5rem] p-3 shadow-2xl ring-4 ring-gray-200 relative">
                ...
                <div className="w-full h-full bg-[#E5DDD5] rounded-[3rem] overflow-hidden flex flex-col relative">
                    ...
                    <div className="h-12 bg-[#075E54] w-full flex justify-between items-end px-6 pb-3 z-20 text-white">
                        <span className="text-[12px] font-semibold">15:15</span>
                    ...
                    <div className="flex-1 p-4 overflow-y-auto relative z-10 flex flex-col pt-6">
                        ...
                        {/* Client Info (Context) */}
                        <div className="bg-white p-3 rounded-xl rounded-tl-none mb-4 self-start shadow-sm max-w-[80%] opacity-60">
                            <p className="text-[14px] text-gray-800">
                                1. Sim, agendamento seria ótimo.<br/>
                                2. Blog por enquanto não.<br/>
                                3. Prazo: 20 dias tá ok.
                            </p>
                            <span className="text-[10px] text-gray-400 block text-right mt-1">15:10</span>
                        </div>
                        ...
                        >
                            <p className="text-[15px] text-gray-800 leading-relaxed whitespace-pre-line">
                                Perfeito, Carolina! Então vou estruturar assim:
                                <br/><br/>
                                ✅ Site institucional responsivo (5 páginas)
                                <br/>
                                ...
                                <br/><br/>
                                <span className="font-bold">Investimento: R$ 3.500</span> (pode parcelar em até 3x)
                                <br/><br/>
                                Monto o contrato e te envio ainda hoje para você olhar com calma. Tudo certo?
                            </p>
                            <div className="flex justify-end items-center gap-1 mt-1.5">
                                <span className="text-[11px] text-gray-400">15:15</span>
                                <div className="flex">
...
export default Slide39_Step4AssumptiveClose;